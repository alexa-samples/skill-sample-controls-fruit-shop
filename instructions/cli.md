...
### Installation
1. **Make sure** you are running the latest version of the ASK-CLI v2.
...
2. **Clone** the repository.
	...
	```bash
	$ git clone https://github.com/alexa/skill-sample-controls-fruit-shop/
	```
...
4. Install npm dependencies by navigating into the skill's `/lambda` directory and running the npm command: `npm install`
	...
	```bash
	$ cd skill-sample-controls-fruit-shop/lambda
	$ npm install
	```
